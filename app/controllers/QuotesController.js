...
function _draw() {
  setHTML('quote', /*html*/`
    <div class="py-2 font-stroke d-flex justify-content-center pointer" onmouseover="app.ImagesController.addDarkFilter()" onmouseleave="app.ImagesController.removeDarkFilter()">
